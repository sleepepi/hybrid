...
class SourceRulesControllerTest < ActionController::TestCase
  ...
  test "should get index" do
    get :index, source_id: sources(:two)
  ...
  test "should get new" do
    get :new, source_id: sources(:two)
    assert_response :success
  end

  test "should create source rule" do
    assert_difference('SourceRule.count') do
      post :create, source_rule: @source_rule.attributes, source_id: sources(:two)
    end
    assert_not_nil assigns(:source)
    assert_not_nil assigns(:source_rule)
    assert_redirected_to source_rule_path(assigns(:source_rule), source_id: assigns(:source).id)
  end

  test "should create source rule with user tokens" do
    assert_difference('SourceRule.count') do
      post :create, source_rule: { actions: ['edit data source rules', 'get count'], user_tokens: "#{users(:admin).to_param},#{users(:pending).to_param}", blocked: false }, source_id: sources(:two)
    end
    assert_not_nil assigns(:source)
    assert_not_nil assigns(:source_rule)
  ...
  test "should create source rule with all blank attributes" do
    assert_difference('SourceRule.count') do
      post :create, source_id: sources(:two)
    end
    assert_not_nil assigns(:source)
    assert_not_nil assigns(:source_rule)
  ...
  test "should show source rule" do
    get :show, id: @source_rule, source_id: @source_rule.source_id
    assert_response :success
  end

  test "should get edit" do
    get :edit, id: @source_rule, source_id: @source_rule.source_id
    assert_response :success
  end

  test "should update source rule" do
    put :update, id: @source_rule, source_rule: { user_tokens: '', description: '', name: '', blocked: true, rules: { 'get_count' => '1' } }, source_id: sources(:two)
    assert_redirected_to source_rule_path(assigns(:source_rule), source_id: assigns(:source).id)
  end

  test "should update source rule with all blank attributes" do
    put :update, id: @source_rule, source_id: sources(:two)
    assert_not_nil assigns(:source_rule)
    assert_equal [], assigns(:source_rule).actions
    assert_equal [], assigns(:source_rule).users
    assert_equal false, assigns(:source_rule).blocked
  ...
  test "should not update source rule with invalid id" do
    put :update, id: -1, source_rule: @source_rule.attributes, source_id: sources(:two)
    assert_nil assigns(:source_rule)
    assert_redirected_to source_rules_path(source_id: assigns(:source))
  end

  test "should destroy source rule" do
    assert_difference('SourceRule.count', -1) do
      delete :destroy, id: @source_rule, source_id: sources(:two)
    end

    assert_redirected_to source_rules_path(source_id: assigns(:source).id)
  end

  test "should not destroy source rule with invalid id" do
    assert_difference('SourceRule.count', 0) do
      delete :destroy, id: -1, source_id: sources(:two)
    end
    assert_nil assigns(:source_rule)
    assert_redirected_to source_rules_path(source_id: assigns(:source))
  end
