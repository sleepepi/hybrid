...
class ReportConceptsControllerTest < ActionController::TestCase
  ...
  test "should create report concept" do
    assert_difference('ReportConcept.count') do
      post :create, search_id: @search, report_id: @report, variable_id: variables(:numeric), format: 'js'
    end
  ...
  test "should not create report concept without valid report and search" do
    assert_difference('ReportConcept.count', 0) do
      post :create, search_id: -1, report_id: -1, variable_id: variables(:numeric), format: 'js'
    end
  ...
  test "should update report concept" do
    put :update, search_id: @search, report_id: @report, id: @report_concept, report_concept: { statistic: '' }, format: 'js'
    assert_not_nil assigns(:search)
    assert_not_nil assigns(:report)
  ...
  test "should not update report concept with invalid id" do
    put :update, search_id: @search, report_id: @report, id: -1, report_concept: { statistic: '' }, format: 'js'
    assert_not_nil assigns(:search)
    assert_not_nil assigns(:report)
  ...
  test "should destroy report concept" do
    assert_difference('ReportConcept.count', -1) do
      delete :destroy, search_id: @search, report_id: @report, id: @report_concept.to_param, format: 'js'
    end
  ...
  test "should not destroy report concept with invalid id" do
    assert_difference('ReportConcept.count', 0) do
      delete :destroy, search_id: @search, report_id: @report, id: -1, format: 'js'
    end
